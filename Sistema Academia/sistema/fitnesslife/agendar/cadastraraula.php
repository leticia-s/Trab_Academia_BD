...
<html>
    <head>
        ...
        <title>Fitness Life - Cadastrar aluno</title>
    ...
    <body>
        <div class="container">
            <form class="form-horizontal" action="/FitnessLife/controller/controlleragenda.php?operacao=salvar" method="POST" onsubmit="return validaCampos()">
                <!-- Form Name -->
