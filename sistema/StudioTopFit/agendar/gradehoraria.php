...
<html>
    <head>
        ...
        <title>STUDIO TOP FIT - Grade Horária</title>
        ...
        <script >
            ...
            function descadastrar(idcpf, idaula, nome, dia, horario) {
                ...
                if (resposta == true) {
                    window.location.href = "/StudioTopFit/controller/controllermeuagendar.php?operacao=descadastrar&idcpf=" + idcpf + "&idaula=" + idaula;
                }
            }
            function cadastrar(idcpf, idaula, nome, dia, horario) {
                ...
                if (resposta == true) {
                    window.location.href = "/StudioTopFit/controller/controllermeuagendar.php?operacao=cadastrar&idcpf=" + idcpf + "&idaula=" + idaula;
                }
            }
        </script>
