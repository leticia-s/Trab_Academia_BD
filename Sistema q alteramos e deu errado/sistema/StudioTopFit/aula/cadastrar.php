...
<html>
    <head>
        ...
        <title>STUDIO TOP FIT - Cadastrar Aula</title>
    ...
    <body>
        <div class="container">
            <form class="form-horizontal" action="/StudioTopFit/controller/controlleraula.php?operacao=salvar" method="POST" onsubmit="">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-2">
                        <input id="nome" name="nome" maxlength="15"  style="width: 170px;" type="text" placeholder="Digite a aula" class="form-control input-md" required="" >
