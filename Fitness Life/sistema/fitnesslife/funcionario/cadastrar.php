...
<html>
    <head>
        ...
        <title>Fitness Life - Cadastrar funcionário</title>
    ...
    <body>
        ...
        <div class="container">
            <form class="form-horizontal" action="/FitnessLife/controller/controllerfuncionario.php?operacao=salvar" method="POST" onsubmit="return validaCampos()">
