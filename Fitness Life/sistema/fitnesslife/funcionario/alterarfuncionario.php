...
<html>
    <head>
        ...
        <title>Fitness Life - Alterar funcionário</title>
        ...
        $pessoa = $funcionarioDao->carregar($_GET['idfuncionario']);
        ...
        <link href="/FitnessLife/css/bootstrap.min.css" rel="stylesheet">
    ...
    <body>
        ...
        <div class="container">
            ...
            <form class="form-horizontal" action="/FitnessLife/controller/controllerfuncionario.php?operacao=alterar" method="POST" onsubmit="return validaCampos()">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4">
                        <input id="cargo" name="cargo" type="text" maxlength="30" value ="<?php echo $pessoa->getCargo_Funcionario(); ?>" placeholder="Digite seu cargo" class="form-control input-md" required="">
