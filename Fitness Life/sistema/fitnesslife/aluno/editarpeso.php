...
<html>
    <head>
        ...
        <title>Fitness Life - Editar peso</title>
    ...
    <body>
        <div class="container">
            <form class="form-horizontal" action="/FitnessLife/controller/controlleraluno.php?operacao=salvarpeso&idcpf=<?php echo $idcpf; ?>" method="POST">
                <!-- Form Name -->
