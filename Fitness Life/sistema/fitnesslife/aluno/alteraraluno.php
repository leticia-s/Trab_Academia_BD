...
<html>
    <head>
        ...
        <title>Fitness Life - Alterar aluno</title>
    ...
    <body>
        ...
        <div class="container">
            ...
            <form class="form-horizontal" action="/FitnessLife/controller/controlleraluno.php?operacao=alterar" method="POST" onsubmit="return validaCampos()">
